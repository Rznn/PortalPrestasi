    ...
    <div class="container mx-auto">
      <div class="flex justify-center">
        <div class="landing-box flex flex-col justify-center items-center" data-aos="fade-up">
          ...
          <h5 class="mt-3 mb-5 text-lg w-3/5">Welcome to Portal Prestasi, your go-to source for the latest competitions, job vacancies, and scholarships. Discover opportunities and stay updated effortlessly.</h5>
    ...
    <div class="mt-20" data-aos="fade-up">
      ...
      <div class="cardview flex-col justify-between mt-24 px-24 rounded-xl" data-aos="fade-left">
        ...
        <div class="flex-col w-full mx-5 justify-between">
          ...
          <p class="mt-4">Discover a wide range of exciting competitions designed to challenge your skills and showcase your talents. Join now to compete with the best, gain recognition, and take your achievements to the next level.</p>
        </div>
      ...
      <div class="cardview flex-col justify-between mt-14 px-24 rounded-xl" data-aos="fade-right">
        ...
        <div class="flex-col mx-5 justify-between text-right">
          ...
          <p class="mt-4">Explore a diverse array of job vacancies tailored to various industries and expertise levels. Find your next career opportunity, connect with top employers, and take the next step towards achieving your professional goals.</p>
        </div>
      ...
      <div class="cardview flex-col justify-between mt-14 px-24 rounded-xl" data-aos="fade-left">
        ...
        <div class="flex-col w-full mx-5 justify-between">
          ...
          <p class="mt-4">Unlock a world of educational opportunities with our comprehensive list of scholarships. Secure financial support for your studies, pursue your academic dreams, and invest in a brighter future.</p>
        </div>
        <div class="info-1 w-full text-end mt-28">
          <a href="/register" class="btn-primary px-6 py-2 rounded-full text-white">
            More Info
